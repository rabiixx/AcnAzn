...
//
import saltmanager.SaltManagerInterface;
//
  ...
  private static void menu (final Subject subject) {
    ...
    do {
      ...
      try {
        ...
        scanner.nextLine();
        final SaltManagerInterface saltManagerInterface = new SaltManagerInterface();
        ...
        switch (opcion) {
          case 1:
            ...
            final byte[] saltData = saltManagerInterface.recover( subject, filename );
          ...
          case 2:
            System.out.print("Introduce nombre de fichero: ");
            filename = scanner.nextLine();
            if ( saltManagerInterface.change( subject, filename ) ) {
